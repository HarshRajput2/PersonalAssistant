...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Harsh"<<endl;
        string phrase = "Good Morning Harsh";
        ...
        cout<< "Good Afternoon Harsh"<<endl;
        string phrase = "Good Afternoon Harsh";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Harsh"<<endl;
        string phrase = "Good Evening Harsh";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    do
    {
        ...
        if(password=="harsh")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Harsh...."<<endl<<endl;

                string phrase = "How can i help you Harsh";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"I'm a personal assistant created by Harsh !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Harsh !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
              ...
              /*  else if(command=="open writepad")
                ...
                {
                    cout<<"Good Bye Harsh, see you soon!"<<endl;
                    string phrase = "Good Bye Harsh, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
